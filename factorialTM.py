...
while(oldHead != head):
    ...
    if state == 0:
        if action('0', '0', R, 0) or action(B, '1', f, 1):
            pass
    
    elif state == 1:
        if action('1', '1', L, 1) or action('0', '0', L, 1) or action(B, B, R, 2):
            pass
        ...
        if action('0', '0', R, 3) or action('1', '1', R, 3) or action(B, '0', f, 4):
            pass
        ...
        if action('0', '0', R, 12) or action('1', '1', R, 12) or action(B, '0', S, 13):
            pass
        ...
        if action('0', '0', L, 3) or action('1', '0', L, 15) or action(X, X, R, 9):
            pass
        ...
        if action('0', B, R, 18) or action('1', B, f, 24) or action(X, X, R, 22):    
            pass

    elif state == 19:
        if action('0', '0', R, 19) or action(X, X, R, 7) or action('1', '1', R, 20):
            pass
        ...
        if action('0', '0', R, 25) or action('1', B, R, 25) or action(B, B, f, 24):
            pass
